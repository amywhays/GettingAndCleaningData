...
From the original features_info.txt file explaining what was measured and how the naming convention is created.  I choose to use names like the original naming convention because it could be easily cross referenced to the original data.
